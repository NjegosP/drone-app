...
const Step = ({
    ...
    <div className='flex items-center gap-1 sm:gap-2'>
        <div
            className={`w-16 h-16 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xl sm:text-sm font-medium ${
                isSelected
...
const StepIndicator = ({
    ...
    <div className='mb-4 sm:mb-6 md:mb-8 p-4 sm:px-6 max-w-3xl mx-auto'>
